...
2. Keep columns with descriptions:
    Държава, в която е направена трансакцията   - column B
    Регистрационен номер на превозно средство   - column Q
    Код на продукт                              - column T   
    Количество                                  - column U
    Нетна стойност във валута на клиента        - column AO
